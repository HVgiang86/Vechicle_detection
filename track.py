...
def detect(opt, line, class_id, result_callback):
    ...
    deepsort = DeepSort(deep_sort_model, max_dist=cfg.DEEPSORT.MAX_DIST, max_iou_distance=cfg.DEEPSORT.MAX_IOU_DISTANCE,
...
def parse_opt(model_path):
    parser = argparse.ArgumentParser()
    parser.add_argument('--yolo_model', nargs='+', type=str, default=model_path, help='model.pt path(s)')
